...
# ============================================================
# PhaseBreathingEstimator — BPM da fase CSI
# ============================================================
# Ispirato da RuView: usa fase (non RSSI) per respirazione.
# Fase è più sensibile a movimenti piccoli (millimetrici) del torace.

PHASE_BREATHING_BANDS = [(0.1, 0.5)]  # 6-30 BPM
